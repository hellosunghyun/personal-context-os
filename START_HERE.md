...
요즘 AI는 점점 더 많은 것을 기억하고, 파일을 읽고, 프로젝트 단위로 맥락을 유지합니다. 그래서 개인 맥락 정리는 덜 필요해지는 것이 아니라 더 중요해집니다.

도구가 나를 기억할수록, 잘못된 기억, 오래된 자기 설명, 공개하면 안 되는 맥락도 함께 영향을 줄 수 있기 때문입니다.

이 가이드는 AI에게 더 많은 정보를 주자는 문서가 아니라, 어떤 정보를 줄지, 어떤 정보는 빼야 할지, 어떤 답변은 제 말이 아닌지 판단하는 기준을 만드는 문서입니다.
